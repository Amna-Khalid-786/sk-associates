...
export default function AdminInsightsPage() {
    ...
    const cards = [
        { title: 'Best Performing Sector', value: 'DHA Phase 5', icon: Target, color: 'text-indigo-600' },
    ...
    return (
        <div className="min-h-screen bg-slate-50 p-8 md:p-12">
            <div className="max-w-6xl mx-auto space-y-12">
                ...
                <header>
                    <h1 className="text-4xl font-black text-slate-900 tracking-tight">AI <span className="text-indigo-600">Insights.</span></h1>
                    <p className="text-slate-500 font-medium">Predictive modeling and growth strategies</p>
                </header>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    {cards.map((card, i) => (
                        <div key={i} className="bg-white p-10 rounded-[3rem] border border-slate-100 shadow-sm border-b-4 border-b-indigo-500/10">
                ...
                <div className="bg-slate-900 p-16 rounded-[4rem] text-white relative overflow-hidden group">
                    <div className="relative z-10 flex flex-col md:flex-row items-center gap-12">
                        <div className="max-w-md">
                            <div className="bg-indigo-500/20 w-16 h-16 rounded-3xl flex items-center justify-center mb-8">
