...
export default function AdminSettingsPage() {
    ...
    const sections = [
        { title: 'General', desc: 'System-wide preferences and identity', icon: Globe, href: '/admin/settings/general', color: 'hover:border-black hover:bg-zinc-100/50 text-black' },
        { title: 'Booking History', desc: 'View all confirmed property inquiries', icon: History, href: '/admin/settings/history', color: 'hover:border-zinc-400 hover:bg-zinc-100/50 text-zinc-600' },
        { title: 'Security', desc: 'Manage access keys and admin roles', icon: Shield, href: '/admin/settings/security', color: 'hover:border-zinc-400 hover:bg-zinc-100/50 text-zinc-600' },
        { title: 'Notifications', desc: 'Email and WhatsApp alert triggers', icon: Bell, href: '/admin/settings/notifications', color: 'hover:border-zinc-400 hover:bg-zinc-100/50 text-zinc-600' },
    ];
    ...
    return (
        <div className="min-h-screen bg-slate-50 p-8 md:p-12">
            <div className="max-w-4xl mx-auto space-y-12">
                ...
                <header>
                    <h1 className="text-4xl font-black text-slate-900 tracking-tight">Admin <span className="text-zinc-500">Settings.</span></h1>
