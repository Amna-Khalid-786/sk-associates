    ...
    return (
        <div className="animate-in fade-in duration-500 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
                <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-3xl shadow-zinc-50 border border-zinc-50">
                    <h2 className="text-2xl font-black text-black mb-8 tracking-tight">Send us a Message</h2>
                    {error && (
                        <div className="bg-zinc-50 border border-zinc-200 text-black p-4 rounded-xl mb-6 text-sm font-bold uppercase tracking-widest">
                            {error}
                        </div>
                    )}
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                                ...
                                <input
                                    required
                                    type="text"
                                    className="w-full bg-zinc-50 border border-zinc-100 rounded-xl px-4 py-4 focus:ring-1 focus:ring-black focus:border-black transition-all outline-none font-medium text-black"
                        ...
                        <div className="space-y-2">
                            ...
                            <textarea
                                required
                                rows={6}
                                className="w-full bg-zinc-50 border border-zinc-100 rounded-xl px-4 py-4 focus:ring-1 focus:ring-black focus:border-black transition-all outline-none resize-none font-medium text-black"
                        ...
                        <button
                            disabled={loading}
                            type="submit"
                            className="bg-black text-white font-black px-10 py-5 rounded-2xl shadow-xl hover:bg-zinc-800 transition-all w-full flex items-center justify-center gap-3 disabled:opacity-50 active:scale-95 text-xs uppercase tracking-widest"
                        >
                ...
                <div className="space-y-12">
                    <div>
                        ...
                        <div className="space-y-6">
                            {offices.map((office) => (
                                <div key={office.city} className="bg-white p-8 rounded-3xl border border-zinc-100 shadow-sm hover:shadow-xl hover:border-black transition-all group">
                                    ...
                                    <p className="text-zinc-500 text-sm mb-4 font-medium">{office.address}</p>
                    ...
                    <div className="bg-black text-white p-10 rounded-[3rem] relative overflow-hidden shadow-2xl shadow-black/10">
                        <div className="relative z-10">
                            <h3 className="text-2xl font-black mb-4 tracking-tight">Urgent Consultation?</h3>
                            <p className="text-zinc-400 text-sm mb-8 font-medium leading-relaxed">Call our central helpline available 24/7 for premium clients and emergency support.</p>
                            <div className="flex items-center space-x-6">
                                <div className="w-14 h-14 bg-white text-black rounded-2xl flex items-center justify-center text-xl shadow-lg">
                                    <Phone className="w-6 h-6" />
                                </div>
                                <div>
                                    <p className="text-[10px] text-zinc-400 uppercase font-black tracking-widest mb-1">24/7 Hotline</p>
