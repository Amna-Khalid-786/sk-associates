    ...
    return (
        <div className="perspective-1000 group">
            ...
            <div className="bg-white rounded-[2.5rem] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.04)] hover:shadow-[0_40px_80px_rgba(79,70,229,0.15)] transition-all duration-700 border border-slate-100 flex flex-col h-full transform-style-3d group-hover:rotate-x-2 group-hover:rotate-y-[-2deg] group-hover:translate-z-10 group-hover:-translate-y-4">
                <div className="relative h-72 overflow-hidden cursor-pointer transform-style-3d">
                    <div className="w-full h-full relative backface-hidden">
                        <SafeImage
                        ...
                        <div className={`absolute top-4 right-4 px-3 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest text-white border border-white/20 ${property.availability === 'Sold' ? 'bg-rose-600' : property.availability === 'Reserved' ? 'bg-amber-500' : 'bg-emerald-600'
                            }`}>
                            {property.availability || 'Available'}
                        </div>
                        <div className="absolute inset-x-0 bottom-0 p-6 bg-gradient-to-t from-slate-950/80 via-slate-950/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity">
